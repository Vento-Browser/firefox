...
const backupFilename = `${BackupService.BACKUP_FILE_NAME}_.html`;
...
add_task(
  async function test_findBackupsInWellKnownLocations_and_multipleFiles() {
    ...
    const ONE = `${BackupService.BACKUP_FILE_NAME}_one_20241201-120000.000.html`;
    ...
    const TWO = `${BackupService.BACKUP_FILE_NAME}_two_20241202-130000.000.html`;
...
add_task(async function test_backupDetectionComplete_telemetry() {
  ...
  // --- Sub-test 1: no source => no event recorded ---
  {
    ...
    await touchBackupFile(
      dir,
      `${BackupService.BACKUP_FILE_NAME}_test_20241201-1200.html`
    );
  ...
  // --- Sub-test 2: source provided, backup found => event with full data ---
  {
    ...
    const FILE = `${BackupService.BACKUP_FILE_NAME}_test_20241201-1200.html`;
